  ...
  return (
    <main style={{ minHeight: "100vh", background: "#050816", color: "white", padding: "20px", fontFamily: "Arial" }}>
      <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "40px" }}>
        ...
        <button style={{ background: "#7C3AED", color: "white", border: 0, borderRadius: "12px", padding: "12px 18px", fontWeight: "bold" }}>
          Sepet
        </button>
      </nav>

      <section style={{ background: "linear-gradient(135deg,#111827,#4C1D95)", borderRadius: "28px", padding: "30px", marginBottom: "35px" }}>
        ...
        <button style={{ marginTop: "18px", background: "#22D3EE", color: "#020617", border: 0, borderRadius: "14px", padding: "14px 22px", fontWeight: "bold" }}>
          Oyunları Keşfet
        </button>
      </section>
      ...
      <section>
        ...
        <div style={{ display: "grid", gap: "18px" }}>
          {games.map((game) => (
            <div key={game.name} style={{ background: "#111827", border: "1px solid #263244", borderRadius: "22px", padding: "22px" }}>
              ...
              <br />
              <button style={{ marginTop: "18px", background: "#7C3AED", color: "white", border: 0, borderRadius: "12px", padding: "12px 18px", fontWeight: "bold" }}>
                Sepete Ekle
              </button>
            </div>
          ))}
